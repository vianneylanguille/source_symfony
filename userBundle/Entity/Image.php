...
/**
 * @ORM\Entity(repositoryClass="eclore\userBundle\Entity\ImageRepository")
...
class Image
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="eclore\userBundle\Entity\Album", inversedBy="pictures")
    ...
    {
        return (string) $this->id.".".$this->ext;
    }
